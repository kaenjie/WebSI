  ...
  return (
    <div className="bg-gradient-to-tr from-[#FFFFFF] from-60% via-[#BDE2FF] via-80% to-[#FFFFFF] to-90% text-black py-16 px-8 lg:px-16">
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-28 items-center gap-12">
          ...
          <div className="lg:pl-14">
            <h1 className="font-bold text-5xl lg:text-6xl leading-tight mb-4 lg:mb-5 text-[#0D255E]">
              Jasa Desain Grafis & Manipulasi Foto
            </h1>
            <p className="text-lg lg:text-xl mb-5 lg:mb-8 text-justify">
              Jasa Desain Grafis berpengalaman yang menangani klien dari
      ...
      <div className="max-w-screen-xl mx-auto py-8 md:pt-12">
        <div className="place-items-center items-center grid grid-cols-6 lg:grid-cols-6 gap-8 justify-center">
          <img
            src={corel}
            alt="CorelDraw"
        ...
        <p className="border border-[#38BDF8] bg-[#E5F6FF] text-[#1D2B50] p-6 rounded-lg flex flex-col items-center justify-center h-24 font-sans text-center text-lg lg:text-xl mt-11 text-[#03346E]">
          Software terbaik yang membantu Grafistix untuk menciptakan Desain dan
          berinovasi
        </p>
      </div>
      ...
      <div className="mt-0 text-center">
        ...
        <p className="text-lg lg:text-xl mb-8 lg:mb-12 max-w-2xl mx-auto">
          ...
          profesional, kreatif, dan berkualitas. Dengan layanan cepat dan hasil
          yang memuaskan.
        </p>
          ...
          {[
            {
              title: "Berkualitas",
              description:
                "Grafistix menyediakan layanan desain grafis berkualitas tinggi dengan fokus pada kreativitas, keahlian, dan kepuasan klien.",
              icon: kualitas,
            },
            {
              title: "Profesional",
              description:
                "Di Grafistix, kami menjamin layanan desain grafis yang profesional, didukung oleh tim ahli yang berkomitmen untuk memenuhi kebutuhan klien dengan tepat dan efisien.",
              icon: profesional,
            },
            {
              title: "Kreatif",
              description:
                "Grafistix mengedepankan kekreatifan dalam setiap proyek desain grafis, menciptakan solusi unik yang memperkuat identitas dan visi merek klien.",
              icon: kreatif,
            },
            {
              title: "Totalitas",
              description:
                "Di Grafistix, kami berkomitmen pada totalitas layanan desain grafis, memastikan setiap detail dikerjakan dengan dedikasi penuh untuk mencapai hasil terbaik bagi klien.",
              icon: totalitas,
            },
            {
              title: "On Time",
              description:
                "Grafistix selalu mengutamakan penyelesaian proyek desain grafis tepat waktu, memastikan kepuasan klien tanpa mengorbankan kualitas.",
              icon: ontime,
            },
            {
              title: "Fast Response",
              description:
                "Grafistix memberikan layanan desain grafis dengan fast response, siap merespon kebutuhan klien dengan cepat dan efisien.",
              icon: fastrespon,
            },
          ].map((item) => (
            <div
      ...
      <div className="mt-12 md:mt-13 text-center">
        <img
          className="w-[110%] md:w-[130%] lg:w-[115%] w-30 mx-auto rounded-lg shadow-lg hover:scale-105 transition-transform"
          src={poster}
