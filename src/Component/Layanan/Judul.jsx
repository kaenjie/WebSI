...
const services = [
  ...
  },
  {
    ...
    title: "Desain Banner",
    description:
      "Desain brosur yang kreatif dan informatif untuk mempromosikan produk atau layanan Anda.",
    icon: "🖼",
  },
  {
    id: 3,
    ...
    description:
      "Desain website responsif dan menarik yang disesuaikan dengan kebutuhan bisnis Anda.",
    icon: "📱",
  },
  {
    id: 4,
    ...
    description:
      "Layanan desain poster untuk acara, promosi, atau kebutuhan branding lainnya.",
    icon: "🎁",
  },
];
...
const Judul = () => {
  return (
    <section
        ...
        >
      {/* Welcome Section */}
      <div className="relative h-auto md:h-screen flex flex-col items-center justify-center text-white py-16 md:py-0 md:-mb-28 l:mb-4">
        {/* Flex container to align image and text side by side */}
        <div className="flex flex-col-reverse lg:flex-row items-center justify-center w-full px-4 md:px-12 lg:px-20">
          {/* Model Image on the left */}
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-start">
            <img
              src={model}
              alt="Hero"
              className="w-[80%] md:w-[70%] lg:w-[80%] h-auto object-cover"
            />
          </div>

          {/* Text and Button on the right */}
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:pl-18">
      ...
      {/* Services Section */}
      <div className="bg-gradient-to-tr rounded-lg from-[#0F172A] from-60% via-[#14203D] via-80% to-[#0F172A] to-90% text-black py-12 md:py-20 pb-20 relative">
      <div className="absolute inset-0 pointer-events-none bg-noise opacity-10"></div>
      <div className="container mx-auto px-8 mb-5 md:mb-12 lg:mb-8 relative z-10">
